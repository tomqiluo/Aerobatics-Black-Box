...
prompt = {'Dial Pointer Detection Toggle: (0 -> Off, 1 -> On)', ...
...
dlg_dims = [1,40];
definput = {'0','2','1','4','1','1.4','1','2','2','0'};
opts.Resize = 'on';
...
dialPoint_toggle = str2double(input_params{1});

% Display Toggle (0 -> Off, 1 -> On, 2 -> Draw circles on image pixels)
disp_toggle = str2double(input_params{2});
