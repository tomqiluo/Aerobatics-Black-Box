...
function [centers, radii, im_overlays] = dial_read(im_original, im_name, disp_toggle, dialPoint_toggle, downsamp, downsamp_fact, gaussBlur, sigma, bilat_filt, edge_adapt, neighborhood, erode)
